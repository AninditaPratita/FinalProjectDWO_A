...
<body>
        ...
        <div id="main">
            <div class="d-flex justify-content-around row">
                <div class="col-6 col-lg-12 col-md-6">
                                <div class="card" style="background-color: #ff243a;">
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row" style="padding-left: 160px;">
                                            ...
                                            <div class="col-md-8">
                                                <h6 class="font-semibold" style="color: white;">Received Quantity</h6>
                                                <h6 class="font-extrabold mb-0" style="color: white;"><?php  echo number_format($row2['count'], 0, ".", ",");?></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <p class="text-subtitle text-muted">All data in received quantity table</p>
                        </div>
    ...
    <?php
    $sql    = mysqli_query($conn, "SELECT p.name, (SELECT SUM(ReceivedQty) FROM fact_purchase AS fp WHERE fp.ProductID = p.ProductId) AS total FROM product AS p ORDER BY `total` DESC LIMIT 10;");
    ...
    <script>
        ...
        var chartProfileVisit = new ApexCharts(document.querySelector("#chart-received-qty"), optionsProfileVisit);
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#datatables').DataTable({
                ...
                'order': [],
                'ajax': {
                    'url': 'fetch_data_receivedqty.php',
                    'type': 'post',
                },
                "aoColumnDefs": [{
                    'aTargets': [4],
