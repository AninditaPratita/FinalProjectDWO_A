...
<body>
                                    ...
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row" style="padding-left: 160px;">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <h6 class="font-extrabold mb-0" style="color: white;"><?php echo $row5['count'];?></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Vendor Table</h3>
                            <p class="text-subtitle text-muted">All data in vendor table</p>
                        </div>
    ...
    <?php
    $sql    = mysqli_query($conn, "SELECT v.name, (SELECT SUM(ReceivedQty) FROM fact_purchase AS fp WHERE fp.VendorID = v.VendorID) AS total FROM vendor AS v ORDER BY `total` DESC LIMIT 10;");
    ...
    <script>
        ...
        var chartProfileVisit = new ApexCharts(document.querySelector("#chart-vendor"), optionsProfileVisit);
